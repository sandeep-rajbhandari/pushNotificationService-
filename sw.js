...
self.addEventListener('push', function(event) {
  ...
  if(Notification.permission=='granted') {
    return self.registration.showNotification("granted", {
      body: "ss",
    });
    ...
    Notification.requestPermission(function(permission) {
      if(permission=='granted') {
        return self.registration.showNotification("permission", {
          icon: 'mf_logo.png'
        });
      }
    });
  ...
  //event.waitUntil(
  //  fetch("https://google.com", fetchInit).then(function(res) {
